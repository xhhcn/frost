...
![Frost on Plasma 6.7 — night scene](screenshot.png)

<sub>Night scene. The accent, wallpaper, splash and lock screen all follow the solar elevation angle.</sub>
...
```bash
bash frost/restore-default.sh     # back to Breeze Dark, keeps Frost's files
